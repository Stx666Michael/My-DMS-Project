...
#define NUMBER_OF_PROCESSES 100 // number of elements to simulate
...
#define PAGE_TABLE_ENTRY_INITIALIZER {.iPID = -1, .iPage = -1, .iFrame = -1, .iAccessed = 0, .iDirty = 0, .m = PTHREAD_MUTEX_INITIALIZER}
