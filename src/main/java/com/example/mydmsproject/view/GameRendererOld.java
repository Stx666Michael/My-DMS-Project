...
import com.example.mydmsproject.controller.old.GameBoard;
import com.example.mydmsproject.model.old.Ball;
import com.example.mydmsproject.model.old.Brick;
import com.example.mydmsproject.model.old.Paddle;
...
public class GameRendererOld extends JComponent {
    ...
    public GameRendererOld(GameBoard gameBoard) {
